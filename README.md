...
- `customTargets`: Boolean for whether custom target elements (not defaulting to next sibling) are being used (via `aria-controls` on trigger element). _Default_: `false`
